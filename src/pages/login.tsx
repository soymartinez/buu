        ...
        <div className='w-screen h-screen grid lg:grid-cols-2'>
            ...
            <div className='flex flex-col gap-2 justify-start h-4/6 items-center place-self-center lg:justify-self-end lg:mx-16 xl:mx-24 w-full px-4 sm:p-0 sm:w-[380px]'>
                ...
                <div className='w-full flex flex-col gap-3 text-font text-sm'>
                    <button onClick={() => signIn('google')} className='flex justify-center gap-2 items-center w-full rounded-md p-2 hover:border-font font-semibold border'>
                    ...
                    <button onClick={() => signIn('github')} className='flex items-center justify-center gap-2 w-full rounded-md p-2 hover:border-font font-semibold border'>
