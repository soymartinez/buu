...
export default function Universidad({ id }: { id: string }) {
    ...
    const [overflow, setOverflow] = useState({ overflow: false, translateX: 0, diff: 0 })
                    ...
                    <section className={`col-span-6 lg:col-span-4 md:rounded-3xl -space-y-3 md:space-y-0 ${data ? 'md:bg-gradient-to-r from-black/70' : ''} md:px-10 md:py-8 relative md:overflow-hidden`}>
                        ...
                        <div className='bg-white md:bg-trasparent px-4 pt-6 md:p-0 relative z-10 rounded-t-3xl flex flex-col gap-4 md:gap-0'>
                            ...
                            <div className='flex flex-col-reverse gap-4 md:block'>
                                    ...
                                    <div className={`flex items-center relative overflow-hidden md:mt-9`}>
                                        ...
                                        <div className={'overflow-hidden'}>
                                            <div
                                                ...
                                                className={`flex gap-2 items-center md:flex-wrap transition duration-300`}>
                                        ...
                                        <button
                                            onClick={() => setOverflow({
                                                ...overflow,
                                                translateX: overflow.diff - 100 < 0 ? overflow.translateX - overflow.diff : overflow.translateX - 100,
                                            })}
                                ...
                                ) : <Skeleton width={'75%'} className={'md:mt-9'} height={36} borderRadius={9999} />}
                            </div>
                        </div>
                    </section>
